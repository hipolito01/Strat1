...
#this class is equivalent to cross_sectiona_MR, but with one difference:
#this class DOES NOT pull data (pricing data for stocks involved)
#so pricing data is an input
class cross_sectional_MR_without_data_pull(object):
    
    
    def __init__(self, pricingData=None, start_date=None,end_date=None,lag=None,size=1,filter1_trigger=None,
        ...
        self.stocks=range(pricingData.shape[1])#useful for the code below
    ...
    def features(self):
        ...
        #-------PULLING DATA------------
        #THIS STEP IS SKIPPED BECAUSE DATA IS AN INPUT 
